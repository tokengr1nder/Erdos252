# Earlier classical criteria and auxiliary examples

These results are retained as verified auxiliary work. They are not the main
E252-derived generalization; see [README.md](README.md) for that development.
