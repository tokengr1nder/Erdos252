...
independently.\\[2pt]
$k=4$ & Pratt (2022).\\[2pt]
$k\ge5$ & Listed as open: catalogue revision of January 2026.\\
\bottomrule
\end{tabular}
\end{center}
...
It bounds the averaged divisor contributions, not $\rho_1$ itself.
...
\end{itemize}
Proof module: \textbf{801 substantive lines; 1,074 total lines}.
...
publication verification receipts review-commit-final-0913 in the local build directory.
...
784303a58ba3361669a236f5f7c5d38c68c352df8ccd3df9e46cc66149d42569.}
\end{frame}
...
The weighted integer is eventually zero, forcing the survivor sum to tend to zero.
\medskip
